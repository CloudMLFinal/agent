        ...
        try:
            ...
            for file_path in changed_files:
                try:
                    ...
                    relative_path = Path(file_path).relative_to(self.repo_dir)
            ...
            # Push to origin
            self.repo.git.push("origin", f"fix/{id}")
            logger.info(f"Fix committed to branch fix/{id}")
